...
res = session.get("https://identity.getpostman.com/api/users/me")
print("User info:", res.status_code)
try:
    print(res.json())
except:
    print(res.text[:500])

res = session.get("https://identity.getpostman.com/api/teams")
print("\nTeams info:", res.status_code)
try:
    print(res.json())
except:
    print(res.text[:500])
