...
def create_and_upgrade_team(profile_path, team_name):
    print(f"\n--- Processing team {team_name} using {profile_path} ---")
...
if __name__ == "__main__":
    ...
    profile = "/home/dev/ChromeProfiles/hunggreen0001@maildrop.cc"
    teams_to_create = ["vinfast-001", "vinfast-002", "vinfast-003"]
    results = []
    
    for team in teams_to_create:
        res = create_and_upgrade_team(profile, team)
        if res:
            results.append(res)
